...
class S3Client:
    ...
    def copy_object(self, src_bucket: str, src_key: str, dst_bucket: str, dst_key: str) -> ObjectInfo:
        log.debug(f"CopyObject s3://{src_bucket}/{src_key} to s3://{dst_bucket}/{dst_key}")
